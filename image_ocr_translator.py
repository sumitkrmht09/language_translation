...
def _ocr_translate(b64_image: str, target_lang: str,
    ...
    prompt = (
        ...
        "Translate ALL text except logos, emblems, and certification marks.\n"
        ...
        "* DO NOT translate text inside company logos, emblems, or certification marks (e.g., NF, CE). For these, you MUST set `translated` exactly equal to `original`.\n"
        "* Preserve numbers, symbols, and product/model codes exactly (set `translated` equal to `original`).\n"
        "* Brand names and proper nouns that do not translate: set `translated` equal to `original`.\n"
